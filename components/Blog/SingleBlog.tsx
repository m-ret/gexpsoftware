    ...
    <>
      ...
      >
        <Link href="/" className="relative block h-[220px] w-full">
          ...
          <Image src={imagen} alt="Imagen Blog" fill 
     sizes="(max-width: 600px) 100vw, (max-width: 1200px) 50vw, 600px" priority={true} />
        ...
        <div className="p-6 sm:p-8 md:py-8 md:px-6 lg:p-8 xl:py-8 xl:px-5 2xl:p-8">
          ...
          <p className="mb-6 border-b border-body-color border-opacity-10 pb-6 text-base font-medium text-body-color text-overflow-ellipsis dark:border-white dark:border-opacity-10 paragraph">
            {paragraph}
          </p>
