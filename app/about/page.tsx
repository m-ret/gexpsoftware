  ...
  return (
    <>
      <Breadcrumb
        ...
        description="Welcome to GEXP Software, a Costa Rican-based company that specializes in providing staff augmentation services for software projects. We were founded in 2015 by a skilled software engineer who was born and raised in the south of Costa Rica. Our founder's passion for frontend development inspired him to start GEXP Software with the goal of providing clients with the resources they need to achieve their goals.
