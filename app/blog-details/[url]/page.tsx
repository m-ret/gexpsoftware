      ...
      try {
        ...
        if (page && data?.data) {
          ...
          setLoading(false);
            ...
            toast.error('Data from API is not in the expected format:', { id: 'dataError' });
          }
        } catch (error) {
          toast.error('Error fetching blog data:', { id: 'fetchError' });
        }
    };
                  ...
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      <div className="flex items-center">
                        <TagButton text={blogData[0]?.tags}  />
                        <TagButton text={blogData[0]?.tags} />
                        <TagButton text={blogData[0]?.tags}  />
                      </div>
                    </div>
